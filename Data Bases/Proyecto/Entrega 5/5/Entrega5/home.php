	...
	<div class="row">
		<div class="col">
			...
			<div class="card mb-3">
			  ...
			  <div class="row h-100 justify-content-center align-items-center">
			  	<img style="height: 50%; width: 50%;" src="imgs/store.png" alt="Store image">
			  </div>
			  <div class="card-body">
		...
		<div class="col">
			<div class="card mb-3">
			  ...
			  <div class="row h-100 justify-content-center align-items-center">
			  	<img style="height: 50%; width: 50%;" src="imgs/cart.png" alt="Cart image">
			  </div>
		...
		<div class="col">
			<div class="card mb-3">
			  ...
			  <div class="row h-100 justify-content-center align-items-center">
			  	<img style="height: 50%; width: 50%;" src="imgs/customer-service.png" alt="Service image">
			  </div>
			  <div class="card-body">
