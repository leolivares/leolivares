	...
	<div class="row h-100 justify-content-center align-items-center">
		<div class="card text-white bg-secondary mb-3" style="width: 80%;">
		  <div class="card-header">
		  	...
		  	<div class="row">
			  	<div class="col-sm-9">
			  	<h4><?php echo $s_store[1]  ?></h4>
			  </div>
			  <div class="col-sm-3">
			  	<form action="service_stats.php" method="get">
						<?php
							echo "<input type='hidden' name='tsid' value='$s_store[0]'>";
						?>
						<button type="submit" class="btn btn-outline-info">Stats</button>
					</form>
			  </div>
			</div>
		  </div>
