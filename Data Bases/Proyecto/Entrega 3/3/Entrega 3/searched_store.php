...
<?php
	include 'consultas/consulta_search_tiendadeproductos.php';
	include 'consultas/consulta_search_tiendadeservicios.php';
?>
						...
						<?php
							...
							foreach ($tiendas_productos as $tienda_p) {
								echo '<tr class="table-primary">
								      <td><a href="store.php?tpid='.$tienda_p[0].'">'.$tienda_p[1].'</a></td>
								      <td>'.$tienda_p[4].'</td>
								    </tr>';
							}
					  ...
					  <div class="tab-pane fade" id="ss">
						...
						<?php
							foreach ($tiendas_servicios as $tienda_s) {
								echo '<tr class="table-primary">
								      <td><a href="s_store.php?tsid='.$tienda_s[0].'">'.$tienda_s[1].'</a></td>
								      <td>'.$tienda_s[6].'</td>
								    </tr>';
							}
